...
class_roster = ['Jonathan Beltran', 'Allison Fernandez', 'Siddhanth Goyal', 'Jingyu He', 'Defne Ikiz', 'Zirui Jiao', 'Pranjal Joshi', 'Dong Hyun Kim', 'Ha Min Ko', 'Kyle Lawson', 'Christine Lee', 'Connie Li',
